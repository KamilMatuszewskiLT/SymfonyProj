...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('backup_manager.command.backup' => function () {
    $f = function (\BM\BackupManagerBundle\Command\BackupCommand $v) { return $v; }; return $f(${($_ = isset($this->services['backup_manager.command.backup']) ? $this->services['backup_manager.command.backup'] : $this->load('getBackupManager_Command_BackupService.php')) && false ?: '_'});
}, 'backup_manager.command.restore' => function () {
    $f = function (\BM\BackupManagerBundle\Command\RestoreCommand $v) { return $v; }; return $f(${($_ = isset($this->services['backup_manager.command.restore']) ? $this->services['backup_manager.command.restore'] : $this->load('getBackupManager_Command_RestoreService.php')) && false ?: '_'});
