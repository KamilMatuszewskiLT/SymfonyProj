...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'backup_manager' => 'getBackupManagerService.php',
            'backup_manager.command.backup' => 'getBackupManager_Command_BackupService.php',
            'backup_manager.command.restore' => 'getBackupManager_Command_RestoreService.php',
        ...
        $this->privates = array(
            ...
            'backup_manager' => true,
            'backup_manager.command.backup' => true,
            'backup_manager.command.restore' => true,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'BMBackupManagerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\backup-manager\\symfony'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'console.command.ids' => array(
                ...
                'console.command.bm_backupmanagerbundle_command_backupcommand' => 'backup_manager.command.backup',
                'console.command.bm_backupmanagerbundle_command_restorecommand' => 'backup_manager.command.restore',
