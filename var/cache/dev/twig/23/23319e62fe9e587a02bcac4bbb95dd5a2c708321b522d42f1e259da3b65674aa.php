...
class __TwigTemplate_ee1dabcf3df83df2168daa5c58b2ce4de22041f9414b5ff5063b908d4401b88b extends Twig_Template
{
...
";
        ...
        <div class=\"row\">
            ...
            if ((1 == $this->getAttribute(($context["paginator"] ?? $this->getContext($context, "paginator")), "currentPage", array()))) {
                ...
                // line 17
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Pierwsza strona", array(), "EasyAdminBundle"), "html", null, true);
                echo "
                            </span>
                        </li>
                    ";
            ...
            if ($this->getAttribute(($context["paginator"] ?? $this->getContext($context, "paginator")), "hasPreviousPage", array())) {
                ...
                // line 31
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Poprzednia strona", array(), "EasyAdminBundle"), "html", null, true);
                echo "
                            </a>
                        </li>
                    ";
            ...
            <div class=\"col-xs-12 col-sm-9\">
                <ul class=\"pagination list-pagination-paginator {{ 1 == paginator.currentPage ? 'first-page' : '' }} {{ paginator.hasNextPage ? '' : 'last-page' }}\">
                    {% if 1 == paginator.currentPage %}
                        <li class=\"disabled\">
                            <span>
                                <i class=\"fa fa-angle-double-left\"></i> {{ 'Pierwsza strona'|trans }}
                            </span>
                        </li>
                    {% else %}
                        <li>
                    ...
                    {% if paginator.hasPreviousPage %}
                        <li>
                            <a href=\"{{ path('easyadmin', _paginator_request_parameters|merge({ page: paginator.previousPage }) ) }}\">
                                <i class=\"fa fa-angle-left\"></i> {{ 'Poprzednia strona'|trans }}
                            </a>
                        </li>
                    {% else %}
                        <li class=\"disabled\">
...
{% endif %}
", "EasyAdminBundle:default:paginator.html.twig", "C:\\wamp64\\bin\\php\\php7.2.4\\DBExample\\vendor\\easycorp\\easyadmin-bundle\\src/Resources/views/default/paginator.html.twig");
    }
}
