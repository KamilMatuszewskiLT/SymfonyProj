...
class __TwigTemplate_8aede6bc28007239dad401f791341bf8e3ec5136025fc8af4c7814044114fdcd extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@EasyAdmin/default/includes/_select2_widget.html.twig"));
...
<script src=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("bundles/easyadmin/javascript/select2/i18n/" . (isset($context["_select2_locale"]) || array_key_exists("_select2_locale", $context) ? $context["_select2_locale"] : (function () { throw new Twig_Error_Runtime('Variable "_select2_locale" does not exist.', 8, $this->source); })())) . ".js")), "html", null, true);
        echo "\"></script>
...
\$(function() {
    ...
    \$('#main').find('form select[data-widget=\"select2\"]').select2({
        ...
        language: '";
        // line 15
        echo twig_escape_filter($this->env, (isset($context["_select2_locale"]) || array_key_exists("_select2_locale", $context) ? $context["_select2_locale"] : (function () { throw new Twig_Error_Runtime('Variable "_select2_locale" does not exist.', 15, $this->source); })()), "html", null, true);
        echo "'
    });
});
</script>
";
    ...
    {
        return array (  50 => 15,  40 => 8,  37 => 7,  35 => 5,  34 => 4,  33 => 3,  31 => 2,  29 => 1,);
    }
...
", "@EasyAdmin/default/includes/_select2_widget.html.twig", "C:\\wamp64\\bin\\php\\php7.2.4\\DBExample\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\default\\includes\\_select2_widget.html.twig");
    }
}
