...
class __TwigTemplate_53fe0f8675e7ac63eeed40926cb0e580ae609f6fc6ebf6c6da77923616928e67 extends Twig_Template
{
    private $source;
            ...
            if (("show" == (isset($context["view"]) || array_key_exists("view", $context) ? $context["view"] : (function () { throw new Twig_Error_Runtime('Variable "view" does not exist.', 3, $this->source); })()))) {
                ...
                ";
                    ...
                    if (((isset($context["_remaining_items"]) || array_key_exists("_remaining_items", $context) ? $context["_remaining_items"] : (function () { throw new Twig_Error_Runtime('Variable "_remaining_items" does not exist.', 19, $this->source); })()) > 0)) {
                        ...
                        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->transchoice("show.remaining_items", (isset($context["_remaining_items"]) || array_key_exists("_remaining_items", $context) ? $context["_remaining_items"] : (function () { throw new Twig_Error_Runtime('Variable "_remaining_items" does not exist.', 20, $this->source); })()), array(), "EasyAdminBundle"), "html", null, true);
                        echo ")</li>
                ";
                    }
                    // line 22
...
{% endif %}
", "@EasyAdmin/default/field_association.html.twig", "C:\\wamp64\\bin\\php\\php7.2.4\\DBExample\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\default\\field_association.html.twig");
    }
}
